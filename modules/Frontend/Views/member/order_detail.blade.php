...
<div id="invoice" class="container p-3">
        ...
        <div class="info mb-3 row">
            ...
            <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <span class="fw-bold">{{ Order::getStatus()[$data->status] }}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
            ...
            <div class="table-responsive mb-3">
                <table class="table table-striped table-hover">
                    ...
                    @foreach($order_details as $key => $order_detail)
                        <tr>
                            <td>{{ $key+1 }}</td>
                            <td><img width="100px" height="100px" style="object-fit: cover" src="{{ asset($order_detail->product->image) }}" alt=""></td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            ...
                            <div class="d-flex justify-content-between">
                                <h5 class="text-success" style="font-weight: 600;">{{ trans('Amount') }}:</h5>
                                <h5 class="text-success" style="font-weight: 600;"> {{ moneyFormat($data->amount) }}</h5>
                            </div>
                        </td>
                    </tr>
                    </tbody>
...
{{--    <button class="btn btn-main print"><i class="fa fa-print"></i></button>--}}
</div>
