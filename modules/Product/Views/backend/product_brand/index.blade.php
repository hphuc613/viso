    ...
    <div id="product-module">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="title">{{ trans("Product Brand") }}</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">{{ trans("Home") }}</a></li>
                        <li class="breadcrumb-item active">{{ trans("Product Brand") }}</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="mb-3 d-flex justify-content-end group-btn">
            <a href="{{ route('get.product_brand.create') }}" class="btn btn-primary"
               data-toggle="modal" data-target="#form-modal" data-title="{{ trans("Create Product Brand") }}">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="text-input">{{ trans("Brand name") }}</label>
                        ...
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td class="link-action">
                                    <a href="{{ route('get.product_brand.update', $item->id) }}" class="btn btn-primary"
                                       data-toggle="modal" data-target="#form-modal"
                                       data-title="{{ trans("Update Product Brand") }}">
                                        <i class="fas fa-pencil-alt"></i></a>
                                    <a href="{{ route('get.product_brand.delete', $item->id) }}"
