    ...
    <div class="setting-module">
        ...
        <div class="row listing">
            ...
            <div class="col-md-6 mb-2">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">{{ trans('Point Exchange') }}</h3>
                        <p class="card-text">{{ trans('To exchange the point.') }}</p>
                        <a href="{{ route("get.setting.pointExchange") }}"
                           class="btn btn-success">{{ trans('Go to config') }}</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-2">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">{{ trans('Payment Setting') }}</h3>
                        <p class="card-text">{{ trans('To config Payments.') }}</p>
                        <a href="{{ route("get.setting.paymentConfig") }}"
                           class="btn btn-success">{{ trans('Go to config') }}</a>
                    </div>
                </div>
            </div>
