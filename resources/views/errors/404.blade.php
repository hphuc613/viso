...
<section id="wrapper" class="error-page">
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <a href="{{ (segmentUrl(0) != 'admin') ? route('get.home.index') : route('admin.dashboard') }}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">{{ trans('Back to home') }}</a>
        </div>
