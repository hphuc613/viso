            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ trans("Attribute") }}</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="mb-3 d-flex justify-content-end group-btn">
            <a href="{{ route('get.attribute.create') }}" class="btn btn-primary"
               data-toggle="modal" data-target="#form-modal" data-title="{{ trans("Create Attribute") }}">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="text-input">{{ trans("Attribute name") }}</label>
                        ...
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td class="link-action">
                                    <a href="{{ route('get.attribute.update', $item->id) }}" class="btn btn-primary">
                                        <i class="fas fa-pencil-alt"></i></a>
                                    <a href="{{ route('get.attribute.delete', $item->id) }}"
